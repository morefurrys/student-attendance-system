    ...
    <div class="login-box-body">
        ...
        <form method="post" action="{{ url('/student-login') }}">
            ...
            <div class="form-group has-feedback {{ $errors->has('username') ? ' has-error' : '' }}">
                <input type="username" class="form-control" name="username" value="{{ old('username') }}" placeholder="@lang('Username')">
        ...
        <a href="{{ url('/student-forgot-password') }}">@lang('Forgot password')</a><br>
        <a href="{{ url('/register') }}" class="text-center">@lang('Register')</a>
