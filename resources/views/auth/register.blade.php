    ...
    <div class="register-box-body">
        ...
        <form method="post" action="{{ url('/register') }}">
            ...
            <div class="form-group has-feedback{{ $errors->has('name') ? ' has-error' : '' }}">
                <input type="text" class="form-control" name="name" value="{{ old('name') }}" placeholder="@lang('Full Name')">
            ...
            <div class="row">
                <div class="col-xs-8">
                    <div class="checkbox icheck">
                        <label>
                            <input type="checkbox"> @lang('I Agree') 
        ...
        <a href="{{ url('/login') }}" class="text-center">@lang('LogIn')</a>
    </div>
    <!-- /.form-box -->
</div>
<!-- /.register-box -->
