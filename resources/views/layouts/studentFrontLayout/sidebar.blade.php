      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="{{url('student-lecture-calender')}}"><i class="fa fa-circle-o"></i> Academic Calender</a></li>
            <li><a href="{{url('student-lecture-activity')}}"><i class="fa fa-circle-o"></i> Semester Activity</a></li>
            <li><a href="{{url('student-exam-marks')}}"><i class="fa fa-circle-o"></i> Exam Marks</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
