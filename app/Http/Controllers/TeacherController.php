...
class TeacherController extends AppBaseController
{
    ...
    public function store(CreateTeacherRequest $request)
    {
        ...
        $image_name = substr(sha1(time()), 0, 16) . '.' . $image->getClientOriginalExtension();

        //will move our image in public folder by creating folder (teacher_images) and store them
        $image->move(\public_path('teacher_images'), $image_name);

        $teacher = new Teacher; //for fillable function in models
        ...
        $teacher->date_registered = date('Y-m-d');
        $teacher->user_id = Auth::id();
        $teacher->image = $request->image_name; //new name image
    ...
    public function InsertClassAttendance(){
